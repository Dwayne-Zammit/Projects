...
def profile():
    ...
    return render_template('profile.html', username=username, image=image, posts_images=posts_images, user=username, posts=posts, followers=followers, following=following)
...
def search_profile():
    ...
    if len(following) != 0:
        ...
        following = str(following)
        following="0 following"
    return render_template('search_profile.html', username=username, image=image, posts_images=posts_images, follow_button=follow_button, following=following, followers=followers, posts=posts)
...
def Search_profile():
    ...
    if len(following) != 0:
        ...
        following = str(following)
        following="0 following"            
    return render_template('search_profile.html', username=username, image=image, posts_images=posts_images, follow_button=follow_button, posts=posts, followers=followers, following=following)
